    ...
    <div class="input__infomation">
      <div class="input__field--contain">
        <div class="input__field-item my-20">
            <label for="HovaTen">Họ Và Tên *</label><input type="text" name="Hoten" value="" id="HovaTen">
        </div>
        <div class="input__field-item my-20">
            <label for="Email">Email *</label><input type="text" name="" value="" id="Email">
        </div>
        <div class="input__field-item my-20">
            <label for="SDT">SDT *</label><input type="text" name="" value="" id="SDT">
        </div>
        <div class="input__field-item my-20">
            <label for="Noidung">Nội Dung</label><textarea type="text" name="" value="" id="Noidung"></textarea>
        </div>
